...
- Kernel backend (`useKernel: true`): `getTypeInfo()` now matches the Thrift backend's canonical 18-column, 20-row type-info result. ([databricks-sql-kernel#291](https://github.com/databricks/databricks-sql-kernel/pull/291), PECOBLR-4166)
