...
/**
 * kernel-auth M1 OAuth U2M end-to-end — **SKIPPED pending browser harness**.
 *
 ...
 *   1. `client.connect({ useKernel: true, authType: 'databricks-oauth' })`
 ...
 *      issues the create-session request to kernel.
 ...
 */
describe('kernel-auth e2e — OAuth U2M through DBSQLClient ↔ KernelBackend ↔ napi binding', function suite() {
