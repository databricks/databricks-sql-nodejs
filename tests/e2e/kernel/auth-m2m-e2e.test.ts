...
import { isBlankOrReserved } from '../../../lib/kernel/KernelAuth';
import { ConnectionOptions } from '../../../lib/contracts/IDBSQLClient';
import { InternalConnectionOptions } from '../../../lib/contracts/InternalConnectionOptions';

/**
 * kernel-auth M1 OAuth M2M end-to-end:
 *   1. Construct a DBSQLClient.
 *   2. `connect({ useKernel: true, authType: 'databricks-oauth', oauthClientId,
 ...
 * kernel-execution feature's own e2e (mirror of the M0 PAT e2e scope at
 ...
 */
describe('kernel-auth e2e — OAuth M2M through DBSQLClient ↔ KernelBackend ↔ napi binding', function suite() {
