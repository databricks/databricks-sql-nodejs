...
/**
 * End-to-end tests for the kernel operation lifecycle (cancel / close /
...
describe('kernel operation lifecycle — end-to-end', function suite() {
  ...
  it('cancel() succeeds against a live kernel statement', async () => {
  ...
  it('close() succeeds against a kernel statement and is idempotent', async () => {
    const binding = getKernelNative() as unknown as NativeBinding;
