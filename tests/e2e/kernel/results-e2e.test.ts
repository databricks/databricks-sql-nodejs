...
// backends. The thrift converter and the kernel converter both surface
...
describe('kernel results end-to-end (pecotesting parity gate)', function suite() {
  ...
  it('kernel backend returns one row with expected columns', async () => {
  ...
  it('Thrift and kernel produce byte-identical rows for the probe query (parity gate)', async () => {
