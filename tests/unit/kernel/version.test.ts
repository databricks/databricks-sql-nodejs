...
import { tryGetKernelNative } from '../../../lib/kernel/KernelNativeLoader';
...
// `KERNEL_NATIVE_EXPECTED=1`. A missing binding there is a real packaging / build
...
function bindingIsExpected(): boolean {
  return process.env.KERNEL_NATIVE_EXPECTED === '1';
}

describe('kernel native binding — smoke test', function smoke() {
